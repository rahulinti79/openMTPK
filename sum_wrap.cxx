...
SWIGEXPORT SEXP
R_swig_sum ( SEXP num1, SEXP num2, SEXP s_swig_copy)
{
  int result;
  int arg1 ;
  int arg2 ;
  ...
  arg1 = static_cast< int >(INTEGER(num1)[0]);
  arg2 = static_cast< int >(INTEGER(num2)[0]);
...
SWIGINTERN R_CallMethodDef CallEntries[] = {
   {"R_swig_sum", (DL_FUNC) &R_swig_sum, 3},
   {NULL, NULL, 0}
};

extern "C" SWIGEXPORT void R_init_sum(DllInfo *dll) {
