...
`fibonacci` = function(n, .copy = FALSE)
{
  n = as.integer(n);
  ...
  ;.Call('R_swig_fibonacci', n, as.logical(.copy), PACKAGE='fib');
  
}

attr(`fibonacci`, 'returnType') = 'integer'
attr(`fibonacci`, "inputTypes") = c('integer')
class(`fibonacci`) = c("SWIGFunction", class('fibonacci'))
